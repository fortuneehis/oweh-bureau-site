...
var render = function (req, res, page, options) {
    ...
    res.render(page, __assign({ pageTitle: "Oweh Bureau | " + ((options === null || options === void 0 ? void 0 : options.description) || page), path: req.path, layout: './layout', params: req.params, query: req.query }, options));
};
